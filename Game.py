...
class Game(PygameGame):
    ...
    def drawInstructions(self,screen):
        ...
        if self.instructionsPage == 1:  #instructions page 1
            ...
            # developing/inhabited description
            ...
            #inhabited planets get larger and larger as time goes on
            if self.frameCount >= 60 and self.frameCount % 3 == 0: 
        ...
        if self.instructionsPage == 2: #instructions page 2
            screen.blit(titleText, titleRect)
            ...
            # eat me invincibility description
        ...
        if self.instructionsPage == 3:   #instructions page 3
    ...
    def drawSplash(self,screen):
        ...
        highScoreRect.centery = (self.height//2)
    ...
    def drawGame(self, screen):
        ...
        #DRAW STATEMENTS
        self.inhabitedGroup.draw(screen) #keep this at bottom of all draw statements
        for star in self.starList:
            pygame.draw.circle(screen, DARKGREY,(star[0],star[1]),2)
